...
def collide_updated():
    for i, j in ti.ndrange(ny, nx):
        ...
        # Compute equilibrium distribution function explicitly
        feq = ti.static([
            2.00 * (-ux2 - uy2                                       + 0.6666666),
            1.00 * ( ux2 + ux  - 0.5 * uy2                           + 0.3333333),
            1.00 * ( uy2 - 0.5 * ux2 + uy                            + 0.3333333),
            0.25 * (-0.5 * ux2 + ux  - 0.5 * uy2 + uy + 1.5 * sum_sq + 0.3333333),
            0.25 * (-0.5 * ux2 + ux  - 0.5 * uy2 - uy + 1.5 * dif_sq + 0.3333333),
            1.00 * ( ux2 - ux  - 0.5 * uy2                           + 0.3333333),
            1.00 * ( uy2 - 0.5 * ux2 - uy                            + 0.3333333),
            0.25 * (-0.5 * ux2 - ux  - 0.5 * uy2 - uy + 1.5 * sum_sq + 0.3333333),
            0.25 * (-0.5 * ux2 - ux  - 0.5 * uy2 + uy + 1.5 * dif_sq + 0.3333333),
        ...
        for q in ti.static(range(9)):
            f_old = f[q, i, j]
            f_new = (1.0 - inv_tau) * f_old + 0.33333333 * rho_per_tau * feq[q]
