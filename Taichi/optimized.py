...
def collide_updated():
    for i, j in ti.ndrange(ny, nx):
        ...
        # fmt: off
        # Compute equilibrium distribution function explicitly
        feq0 = rho_ij * (-2.0/3.0 * u0**2 - 2.0/3.0 * u1**2 + 4.0/9.0)
        feq1 = rho_ij * ((1.0/3.0) * u0**2 + (1.0/3.0) * u0 - 1.0/6.0 * u1**2 + 1.0/9.0)
        feq2 = rho_ij * (-1.0/6.0 * u0**2 + (1.0/3.0) * u1**2 + (1.0/3.0) * u1 + 1.0/9.0)
        feq3 = rho_ij * (-1.0/24.0 * u0**2 + (1.0/12.0) * u0 - 1.0/24.0 * u1**2 + 
                            (1.0/12.0) * u1 + (1.0/8.0) * (u0 + u1)**2 + 1.0/36.0)
        feq4 = rho_ij * (-1.0/24.0 * u0**2 + (1.0/12.0) * u0 - 1.0/24.0 * u1**2 - 
                            1.0/12.0 * u1 + (1.0/8.0) * (u0 - u1)**2 + 1.0/36.0)
        feq5 = rho_ij * ((1.0/3.0) * u0**2 - 1.0/3.0 * u0 - 1.0/6.0 * u1**2 + 1.0/9.0)
        feq6 = rho_ij * (-1.0/6.0 * u0**2 + (1.0/3.0) * u1**2 - 1.0/3.0 * u1 + 1.0/9.0)
        feq7 = rho_ij * (-1.0/24.0 * u0**2 - 1.0/12.0 * u0 - 1.0/24.0 * u1**2 - 
                            1.0/12.0 * u1 + (1.0/8.0) * (-u0 - u1)**2 + 1.0/36.0)
        feq8 = rho_ij * (-1.0/24.0 * u0**2 - 1.0/12.0 * u0 - 1.0/24.0 * u1**2 + 
                            (1.0/12.0) * u1 + (1.0/8.0) * (-u0 + u1)**2 + 1.0/36.0)
