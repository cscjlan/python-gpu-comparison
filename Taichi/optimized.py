...
def collide_updated():
    for i, j in ti.ndrange(ny, nx):
        if nodetype[i, j] <= 0:
            ...
            feq1 =        rho[i, j] * ( 1.0/3.0 * u[0, i, j]**2 - 1.0/6.0 * u[1, i, j]**2 + 1.0/3.0 * u[0, i, j]                                                                 + 1.0/9.0)
            feq5 =        rho[i, j] * ( 1.0/3.0 * u[0, i, j]**2 - 1.0/6.0 * u[1, i, j]**2 - 1.0/3.0 * u[0, i, j]                                                                 + 1.0/9.0)
            feq2 =        rho[i, j] * ( 1.0/3.0 * u[1, i, j]**2 - 1.0/6.0 * u[0, i, j]**2 + 1.0/3.0 * u[1, i, j]                                                                 + 1.0/9.0)
            feq6 =        rho[i, j] * ( 1.0/3.0 * u[1, i, j]**2 - 1.0/6.0 * u[0, i, j]**2 - 1.0/3.0 * u[1, i, j]                                                                 + 1.0/9.0)
