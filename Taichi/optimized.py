...
def collide_updated():
    for i, j in ti.ndrange(ny, nx):
        ...
        # fmt: off
        # Compute equilibrium distribution function explicitly
        feq0 = rho_ij * (-2.0/3.0 * u[0, i, j]**2 - 2.0/3.0 * u[1, i, j]**2 + 4.0/9.0)
        feq1 = rho_ij * ((1.0/3.0) * u[0, i, j]**2 + (1.0/3.0) * u[0, i, j] - 1.0/6.0 * u[1, i, j]**2 + 1.0/9.0)
        feq2 = rho_ij * (-1.0/6.0 * u[0, i, j]**2 + (1.0/3.0) * u[1, i, j]**2 + (1.0/3.0) * u[1, i, j] + 1.0/9.0)
        feq3 = rho_ij * (-1.0/24.0 * u[0, i, j]**2 + (1.0/12.0) * u[0, i, j] - 1.0/24.0 * u[1, i, j]**2 + 
                            (1.0/12.0) * u[1, i, j] + (1.0/8.0) * (u[0, i, j] + u[1, i, j])**2 + 1.0/36.0)
        feq4 = rho_ij * (-1.0/24.0 * u[0, i, j]**2 + (1.0/12.0) * u[0, i, j] - 1.0/24.0 * u[1, i, j]**2 - 
                            1.0/12.0 * u[1, i, j] + (1.0/8.0) * (u[0, i, j] - u[1, i, j])**2 + 1.0/36.0)
        feq5 = rho_ij * ((1.0/3.0) * u[0, i, j]**2 - 1.0/3.0 * u[0, i, j] - 1.0/6.0 * u[1, i, j]**2 + 1.0/9.0)
        feq6 = rho_ij * (-1.0/6.0 * u[0, i, j]**2 + (1.0/3.0) * u[1, i, j]**2 - 1.0/3.0 * u[1, i, j] + 1.0/9.0)
        feq7 = rho_ij * (-1.0/24.0 * u[0, i, j]**2 - 1.0/12.0 * u[0, i, j] - 1.0/24.0 * u[1, i, j]**2 - 
                            1.0/12.0 * u[1, i, j] + (1.0/8.0) * (-u[0, i, j] - u[1, i, j])**2 + 1.0/36.0)
        feq8 = rho_ij * (-1.0/24.0 * u[0, i, j]**2 - 1.0/12.0 * u[0, i, j] - 1.0/24.0 * u[1, i, j]**2 + 
                            (1.0/12.0) * u[1, i, j] + (1.0/8.0) * (-u[0, i, j] + u[1, i, j])**2 + 1.0/36.0)

        # Collision step
        f[0, i, j] = (1.0 - s) * f[0, i, j] + s * ((1.0 - inv_tau) * f[0, i, j] + inv_tau * feq0)
        f[1, i, j] = (1.0 - s) * f[1, i, j] + s * ((1.0 - inv_tau) * f[1, i, j] + inv_tau * feq1)
        f[2, i, j] = (1.0 - s) * f[2, i, j] + s * ((1.0 - inv_tau) * f[2, i, j] + inv_tau * feq2)
        f[3, i, j] = (1.0 - s) * f[3, i, j] + s * ((1.0 - inv_tau) * f[3, i, j] + inv_tau * feq3)
        f[4, i, j] = (1.0 - s) * f[4, i, j] + s * ((1.0 - inv_tau) * f[4, i, j] + inv_tau * feq4)
        f[5, i, j] = (1.0 - s) * f[5, i, j] + s * ((1.0 - inv_tau) * f[5, i, j] + inv_tau * feq5)
        f[6, i, j] = (1.0 - s) * f[6, i, j] + s * ((1.0 - inv_tau) * f[6, i, j] + inv_tau * feq6)
        f[7, i, j] = (1.0 - s) * f[7, i, j] + s * ((1.0 - inv_tau) * f[7, i, j] + inv_tau * feq7)
        f[8, i, j] = (1.0 - s) * f[8, i, j] + s * ((1.0 - inv_tau) * f[8, i, j] + inv_tau * feq8)
        # fmt: on
