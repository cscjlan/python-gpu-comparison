...
def collide_updated():
    for i, j in ti.ndrange(ny, nx):
        if nodetype[i, j] <= 0:
            ...
            feq1 = 0.5  * rho[i, j] * ( 2.0/3.0 * u[0, i, j]**2 - 1.0/3.0 * u[1, i, j]**2 + 2.0/3.0 * u[0, i, j]                                                                 + 2.0/9.0)
            feq5 = 0.5  * rho[i, j] * ( 2.0/3.0 * u[0, i, j]**2 - 1.0/3.0 * u[1, i, j]**2 - 2.0/3.0 * u[0, i, j]                                                                 + 2.0/9.0)
            feq2 = 0.5  * rho[i, j] * ( 2.0/3.0 * u[1, i, j]**2 - 1.0/3.0 * u[0, i, j]**2 + 2.0/3.0 * u[1, i, j]                                                                 + 2.0/9.0)
            feq6 = 0.5  * rho[i, j] * ( 2.0/3.0 * u[1, i, j]**2 - 1.0/3.0 * u[0, i, j]**2 - 2.0/3.0 * u[1, i, j]                                                                 + 2.0/9.0)
            feq3 = 0.25 * rho[i, j] * (-1.0/6.0 * u[0, i, j]**2 - 1.0/6.0 * u[1, i, j]**2 + 1.0/3.0 * u[0, i, j] + 1.0/3.0 * u[1, i, j] + 1.0/2.0 * (u[0, i, j] + u[1, i, j])**2 + 1.0/9.0)
            feq7 = 0.25 * rho[i, j] * (-1.0/6.0 * u[0, i, j]**2 - 1.0/6.0 * u[1, i, j]**2 - 1.0/3.0 * u[0, i, j] - 1.0/3.0 * u[1, i, j] + 1.0/2.0 * (u[0, i, j] + u[1, i, j])**2 + 1.0/9.0)
            feq4 = 0.25 * rho[i, j] * (-1.0/6.0 * u[0, i, j]**2 - 1.0/6.0 * u[1, i, j]**2 + 1.0/3.0 * u[0, i, j] - 1.0/3.0 * u[1, i, j] + 1.0/2.0 * (u[0, i, j] - u[1, i, j])**2 + 1.0/9.0)
            feq8 = 0.25 * rho[i, j] * (-1.0/6.0 * u[0, i, j]**2 - 1.0/6.0 * u[1, i, j]**2 - 1.0/3.0 * u[0, i, j] + 1.0/3.0 * u[1, i, j] + 1.0/2.0 * (u[0, i, j] - u[1, i, j])**2 + 1.0/9.0)
